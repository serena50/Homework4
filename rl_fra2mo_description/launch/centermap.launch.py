...
def generate_launch_description():
    ...
    rviz_config = os.path.join(get_package_share_directory('rl_fra2mo_description'), 'rviz_conf', 'explore.rviz')
    ...
    # Add this to your existing bridge node arguments in gazebo_fra2mo.launch.py
    bridge = Node(
        package='ros_gz_bridge',
        executable='parameter_bridge',
    ...
    nodes_to_start = [robot_state_publisher_node, joint_state_publisher_node, *ign, bridge, 
                      odom_tf, laser_id_link_tf, ign_clock_bridge, rviz_node]
